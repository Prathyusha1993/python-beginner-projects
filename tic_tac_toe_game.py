# tic tac toe - 3 rows and 3 columns
# two players - x and o
#if o turn enters row and colum
# x turn enters row and column
# first player aligns three of their marks either vertically, horizontally, or diagonally wins
# board is printed after each move
# when board id full resulting to draw
...
def get_move(current_player):
    ...
    while True:
        ...
        print('This sopt is already taken')
